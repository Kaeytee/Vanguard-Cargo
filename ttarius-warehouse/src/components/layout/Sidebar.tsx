...
const Sidebar: React.FC<SidebarProps> = ({ isOpen = false, onToggle }) => {
  ...
  const NavItem: React.FC<{ 
    ...
    <NavLink
      ...
      className={({ isActive }) => 
        `flex items-center px-6 py-4 text-white hover:bg-blue-700 transition-colors duration-200 group ${
  ...
  const sidebarContent = (
    <>
      {/* Logo section */}
      <div className="px-6 py-6 bg-blue-800">
      ...
      <nav className="flex-1 py-6">
        ...
        <div className="mt-auto">
          ...
          <button 
            ...
            className="flex items-center w-full px-6 py-4 text-white hover:bg-blue-700 transition-colors duration-200 group"
          >
      ...
      <div className="bg-blue-800 p-6 mt-auto">
  ...
  return (
    <>
      ...
      {/* Desktop Sidebar */}
      <aside className="hidden md:flex md:flex-col w-64 bg-blue-900 h-full overflow-y-auto">
        {sidebarContent}
      </aside>
      
      {/* Mobile Sidebar */}
      <aside className={`
        fixed top-0 left-0 z-50 w-64 h-full bg-blue-900 transform transition-transform duration-300 ease-in-out md:hidden overflow-y-auto
