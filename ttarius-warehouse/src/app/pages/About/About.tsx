...
const About: React.FC = () => (
  <div className="py-10 px-6 max-w-3xl mx-auto">
    <h1 className="text-3xl font-bold text-blue-700 mb-4">About Vanguard Cargo</h1>
    <p className="text-gray-700 text-lg mb-2">
      Vanguard Cargo is a modern logistics management platform designed to streamline shipment, warehouse, and client operations. Our mission is to deliver seamless, transparent, and efficient logistics services for businesses of all sizes.
    </p>
