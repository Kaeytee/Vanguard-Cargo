  ...
  const getPriorityBadgeClass = useCallback((priority: PackagePriority): string => {
    switch (priority) {
      ...
      case PackagePriority.LOW:
        return 'px-2 py-1 text-xs font-semibold rounded-full bg-blue-100 text-blue-800 border border-blue-200';
      default:
      ...
      <div className="mb-6 space-y-4">
        ...
        <div className="flex gap-4 items-center">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-3 bg-blue-50 text-blue-700 border border-blue-200 rounded-lg font-medium hover:bg-blue-100 transition-colors duration-200"
          >
