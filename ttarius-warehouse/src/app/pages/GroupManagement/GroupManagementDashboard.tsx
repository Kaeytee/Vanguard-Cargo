...
const GroupManagementDashboard: React.FC = () => {
 ...
 const handleUpdateGroup = useCallback(async (updateData: GroupUpdateData) => {
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
      ...
      <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-[0_2px_8px_rgba(0,0,0,0.1)] flex items-center gap-4 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_4px_16px_rgba(0,0,0,0.15)]">
        ...
        <div>
          ...
          <p className="text-3xl font-bold text-blue-600">{stats.groupedPackages}</p>
        </div>
      </div>
  ...
  const renderQuickActions = () => (
    <div className="bg-blue-50 rounded-lg border border-gray-200 p-6 mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <button
          ...
          className="flex items-center justify-center gap-3 px-5 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200 font-semibold text-sm"
  ...
  const renderRecentGroups = () => (
    <div className="bg-blue-50 rounded-lg border border-gray-200 p-6">
