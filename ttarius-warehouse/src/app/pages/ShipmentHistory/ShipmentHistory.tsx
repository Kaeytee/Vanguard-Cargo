  ...
  const handleExportCSV = async (): Promise<void> => {
    try {
      ...
      const csvContent = [
        ...
        '# Generated by: Vanguard Warehouse Management System',
        '# Contact: support@Vanguard.com',
        '',
        '# SHIPMENT DATA',
        headers.join(','),
      ...
      if (link.download !== undefined) {
        ...
        const filename = `Vanguard_Shipment_History${filterSuffix}_${timestamp}.csv`;
  ...
  const mockPackages: Package[] = [
    {
      ...
      // METADATA
      createdBy: 'admin@Vanguard.com',
      lastModifiedBy: 'admin@Vanguard.com',
      version: 1
    },
    {
      // IDENTIFICATION
      ...
      // METADATA
      createdBy: 'staff@Vanguard.com',
      lastModifiedBy: 'staff@Vanguard.com',
      version: 2
    },
    {
      // IDENTIFICATION
      ...
      // METADATA
      createdBy: 'admin@Vanguard.com',
      lastModifiedBy: 'delivery@Vanguard.com',
      version: 4
    }
  ];
