  ...
  const handleExportCSV = async (): Promise<void> => {
    try {
      ...
      const csvContent = [
        ...
        '# Generated by: Vangaurd Warehouse Management System',
        '# Contact: support@Vangaurd.com',
        '',
        '# SHIPMENT DATA',
        headers.join(','),
      ...
      if (link.download !== undefined) {
        ...
        const filename = `Vangaurd_Shipment_History${filterSuffix}_${timestamp}.csv`;
  ...
  const mockPackages: Package[] = [
    {
      ...
      // METADATA
      createdBy: 'admin@Vangaurd.com',
      lastModifiedBy: 'admin@Vangaurd.com',
      version: 1
    },
    {
      // IDENTIFICATION
      ...
      // METADATA
      createdBy: 'staff@Vangaurd.com',
      lastModifiedBy: 'staff@Vangaurd.com',
      version: 2
    },
    {
      // IDENTIFICATION
      ...
      // METADATA
      createdBy: 'admin@Vangaurd.com',
      lastModifiedBy: 'delivery@Vangaurd.com',
      version: 4
    }
  ];
