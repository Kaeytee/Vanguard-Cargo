        ...
        <div className="bg-white w-full sm:max-w-md sm:mx-4 rounded-t-2xl sm:rounded-2xl shadow-xl animate-fadeIn max-h-[95vh] flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4">
            ...
            <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <h3 className="font-medium text-blue-800 mb-2 text-sm">📷 Package Images</h3>
              ...
              {capturedImages.length > 0 ? (
                ...
                <button
                  onClick={() => setShowImageCapture(true)}
                  className="bg-blue-600 hover:bg-blue-700 text-white px-3 py-2 rounded-lg font-medium text-xs flex items-center gap-2"
                >
                  📷 Take Package Photos
                </button>
              )}
          ...
          <div className="p-4 sm:p-6 border-t border-gray-200 flex-shrink-0">
            <div className="flex gap-3">
              ...
              <button
                ...
                className={`flex-1 bg-blue-900 hover:bg-blue-800 text-white py-2 px-4 rounded-lg font-semibold shadow text-sm ${
