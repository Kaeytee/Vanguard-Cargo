...
VITE_API_BASE_URL=https://api.ttarius-logistics.com/api
VITE_APP_NAME=Ttarius Warehouse
...
| `VITE_API_BASE_URL` | http://localhost:3001/api | https://api.ttarius-logistics.com/api | API base URL |
