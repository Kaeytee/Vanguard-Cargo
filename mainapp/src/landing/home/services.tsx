  ...
  const serviceItems = [
    {
      ...
      title: "Air Freight",
      description:
        "Fast and reliable air transportation solutions for time-sensitive cargo.",
    },
    {
      icon: Ship,
      title: "Ocean Freight",
      description:
        "Cost-effective shipping solutions for large volume cargo across global waters.",
    },
    {
      icon: Truck,
      title: "Land Freight",
      description:
        "Efficient ground transportation with extensive network coverage.",
    },
    {
      icon: Globe,
      title: "Global Solutions",
      description:
        "Expert customs brokerage and international logistics management.",
    },
  ];
                ...
                <motion.div whileHover={{ y: -5 }} className="h-full">
                  <div
                    className={cn(
                      ...
                      isHovered && "border-red-500 shadow-red"
                    )}
                  ...
                  >
                    <motion.div
                      className={cn(
                        ...
                        isHovered && "bg-red-50 text-red-500"
                      )}
                      animate={
                        isHovered
                          ? { scale: 1.1, rotate: 5 }
