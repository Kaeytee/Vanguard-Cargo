...
export default function SubmitShipmentPage() {
  ...
  return (    <div className="min-h-screen px-4 sm:px-10 py-6 bg-gray-100 transition-colors duration-300">
      ...
      {/* Popup Loader */}
      {showLoader && (        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center transition-opacity duration-300">
      ...
      {/* Error messages */}
      {validationErrors.length > 0 && (        <div className="w-full md:w-[90%] lg:w-[85%] mx-auto mb-4 p-4 bg-red-50 border border-red-200 rounded-lg text-red-700">
      ...
      {stepValidationError && (        <div className="w-full md:w-[90%] lg:w-[85%] mx-auto mb-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg text-yellow-700">
      ...
      {/* Form */}
      {/* Main form container - opened here, closed after form */}      <div className="w-full md:w-[90%] lg:w-[85%] mx-auto px-4 sm:px-8 md:px-12 lg:px-20 py-6 md:py-8 lg:py-10 bg-white border border-gray-300 shadow-md rounded-lg transition-all duration-300">
