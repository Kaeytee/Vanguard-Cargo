      ...
      if (
        ...
        if (isMobile) {
          ...
          if (dropdownRect.bottom > window.innerHeight) {
            ...
            if (spaceAbove > dropdownHeight + 40) {
    ...
    if (dateFilterActive && startDate && endDate) {
      ...
      if (parsedStartDate && parsedEndDate) {
        ...
        return searchFiltered.filter((shipment) => {
          ...
          return (
            shipmentDate >= parsedStartDate && shipmentDate <= parsedEndDate
          );
        });
      }
    }
      ...
      <div className="relative mb-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 sm:gap-3 md:gap-4 px-4 sm:px-6 md:px-8 lg:px-10 pb-2">
          {Object.entries(statuses).map(([key, label]) => (
            <div
              key={key}
              className={`bg-white shadow rounded-lg overflow-hidden cursor-pointer transition-all duration-200 h-full ${
                activeTab === key
          ...
          <div className="p-4 border-b border-gray-200 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="relative flex items-center w-full sm:w-auto">
              <button
                ...
                className={`flex items-center justify-center space-x-1 px-3 py-2 border ${
                  dateFilterActive
                    ? "border-blue-500 bg-blue-50"
                    : "border-gray-300 bg-white"
                } rounded-md hover:bg-gray-50 w-full sm:w-auto`}
              ...
              >
                <Calendar
                  size={16}
                  className={
                    dateFilterActive ? "text-blue-500" : "text-gray-500"
                  }
                />
                ...
                <span className="text-sm ml-1 inline sm:hidden">
                  {dateFilterActive ? "Date Range" : "Date"}
                </span>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        <div className="flex items-center">
                          <span className="mr-2">
                            ...
                            >
                              <path
                                d="M5.252 10.4487L16.912 4.89671C18.612 4.08671 20.386 5.86171 19.577 7.56271L14.025 19.2217C13.266 20.8147 10.966 20.7167 10.346 19.0637L9.32 16.3247C9.21975 16.0575 9.06347 15.8148 8.86167 15.613C8.65986 15.4112 8.41721 15.255 8.15 15.1547L5.41 14.1277C3.758 13.5077 3.659 11.2077 5.252 10.4487Z"
                                stroke="#A3A3A3"
                                strokeWidth="1.5"
                                strokeLinecap="round"
                                strokeLinejoin="round"
                  ...
                  <div>
                    ...
                    >
                      ...
                      {paginationData.pageNumbers.map((pageNum, idx) => {
                        ...
                        const previousPage =
                          paginationData.pageNumbers[idx - 1];
