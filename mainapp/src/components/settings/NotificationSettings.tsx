    ...
    <div className="max-w-3xl mx-auto">
      ...
      <form className="space-y-6">
        <div>
          ...
          <div className="border-b border-b-gray-300 py-3 flex items-center justify-between">
            <div>
              <h3 className="text-md font-semibold">Delivery Alerts</h3>              <p className="text-gray-400">Get notifications once your package is delivered</p>
            </div>
          ...
          <div className="border-b border-b-gray-300 py-3 flex items-center justify-between">
            <div>
              <h3 className="text-md font-semibold">Delay Notifications</h3>              <p className="text-gray-400">Be alerted if there is a delay with your shipment</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input type="checkbox" className="sr-only peer" />
              <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary"></div>
