 ...
 */
const AppNavbar: React.FC<AppNavbarProps> = ({ onToggleSidebar, isSidebarOpen }) => {
  ...
  const notifications = [
    { id: 1, message: 'Your shipment has been delivered', isRead: false, time: '5m ago' },
    { id: 2, message: 'New shipment request received', isRead: true, time: '1h ago' },
    { id: 3, message: 'Payment confirmed for shipment #12345', isRead: true, time: '3h ago' }
  ];
    ...
    <>
      <div className="flex justify-between items-center px-4 py-3 bg-white shadow-md h-16 relative z-40">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className={`welcome-section ${showMobileSearch ? 'hidden' : 'block'} sm:block`}>
            <h2 className="text-lg sm:text-xl lg:text-2xl text-gray-800 font-semibold">Welcome</h2>
          </div>
        </div>
              ...
              <div className="absolute right-0 mt-2 bg-white rounded-lg shadow-xl border min-w-[250px] z-50">
                <div className="flex items-center gap-3 p-4 border-b border-gray-200">
                  ...
                  <div className="flex-1 min-w-0">
                    <h4 className="text-base font-medium text-gray-800 truncate">{userData.name}</h4>
