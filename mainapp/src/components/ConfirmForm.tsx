...
const ConfirmForm: React.FC<ConfirmFormProps> = ({
  ...
  const SectionTitle = ({ title }: { title: string }) => (
    <h3 className="text-lg font-semibold text-[#1A2B6D] border-b border-gray-200 pb-2 mb-3">{title}</h3>
  );
  ...
  return (
    <div className="space-y-6" data-testid="confirm-form">
      ...
      <form onSubmit={(e) => {
        ...
        {/* Summary sections */}
        <div className="mt-8 space-y-8 bg-gray-50 rounded-lg p-4 sm:p-6">
          {/* Client Information */}
          <div>
        ...
        <div className="space-y-4">
          <div className="p-4 sm:p-6 bg-blue-50 text-blue-800 rounded-lg text-sm sm:text-base">
          ...
          <div className="p-4 sm:p-6 bg-green-50 text-green-800 rounded-lg text-sm sm:text-base flex items-start">
          ...
          <div className="flex flex-col sm:flex-row justify-between space-y-4 sm:space-y-0 sm:space-x-4 mt-8">
            ...
            <button
              ...
              className="px-6 py-3 bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
